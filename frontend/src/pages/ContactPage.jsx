              ...
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="name" className="text-white text-sm font-semibold mb-2 block cursor-pointer">
                        Full Name *
                      </label>
                      <Input
                        id="name"
                    ...
                    <div>
                      <label htmlFor="email" className="text-white text-sm font-semibold mb-2 block cursor-pointer">
                        Email Address *
                      </label>
                      <Input
                        id="email"
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="phone" className="text-white text-sm font-semibold mb-2 block cursor-pointer">
                        Phone Number
                      </label>
                      <Input
                        id="phone"
                    ...
                    <div>
                      <label htmlFor="subject" className="text-white text-sm font-semibold mb-2 block cursor-pointer">
                        Subject *
                      </label>
                      <Input
                        id="subject"
                  ...
                  <div>
                    <label htmlFor="message" className="text-white text-sm font-semibold mb-2 block cursor-pointer">
                      Message *
                    </label>
                    <Textarea
                      id="message"
