...
ADMIN_TOKEN = os.getenv("ADMIN_SECRET_TOKEN", "test_secret_token")

# Test data
TEST_CONTACT_DATA = {
    "name": "Reigneth G. Villena",
    "email": "ArchitectReign@likhahome.com", 
...
TEST_NEWSLETTER_DATA = {
    "email": "likhahomebuilder@gmail.com"
}

TEST_PURCHASE_DATA = {
    "name": "Benjohn U.Carino",
    "email": "benjohncarino@gmail.com",
    "phone": "+63 9193244262", 
